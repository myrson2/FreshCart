...
import { addProduct, updateProduct } from "./display/crud.js";

//render all the products in the dashboard
export const inventoryTableBody = document.getElementById("inventory-tbody-styled");
      ...
      if (product.status === 'EXPIRED' || product.status === 'OUT OF STOCK') {
        if (confirm("Are you sure you want to delete this product?")) {
          try {
            ...
            displayAllProducts(ItemManager.getAllProducts());// refresh table
          } catch (error) {
            console.error(error);
          }
        }
